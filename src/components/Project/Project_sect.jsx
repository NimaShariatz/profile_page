...
import {project_pic, renewWool, upcycle, henning_logo, ashbloom_pic} from "../../constants/index.js"
          ...
          <div className='grid_container'>
            ...
            <div className='a_project'>
              ...
              <div style={{display:"flex", justifyContent: "space-between", paddingBlock:"30px"}}>
                ...
                <a href='https://2025.igem.wiki/ualberta/' target='#blank' className='project_link'>Check Live Site <svg viewBox="0 0 24 24"><path d="M5 17.59L15.59 7H9V5h10v10h-2V8.41L6.41 19z"/></svg></a>
              </div>
            </div>
            ...
            <div className='a_project'>
              ...
              <div style={{display:"flex", justifyContent: "space-between", paddingBlock:"30px"}}>
                ...
                <a href='https://2024.igem.wiki/ualberta/description' target='#blank' className='project_link'>Check Live Site <svg viewBox="0 0 24 24"><path d="M5 17.59L15.59 7H9V5h10v10h-2V8.41L6.41 19z"/></svg></a>
              </div>
            </div>
