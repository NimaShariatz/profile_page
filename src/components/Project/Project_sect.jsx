...
const Project_sect = () => {
    ...
    useEffect(() => {
        ...
        gsap.to("#project_div", { height: '100%', duration: 3, ease:"back.out", delay: 1, opacity:1, onComplete: () => {
            gsap.to("#project_div", { scale: '1.1', duration: 8, ease: "sine.inOut", yoyo: true, repeat: -1 });
            gsap.to("#project_div", { scale: '1.2', duration: 8, ease: "sine.inOut", yoyo: true, repeat: -1});
        }});
      ...
      return (
        ...
        <div style={{position: "relative"}}>
          ...
          <img className="project_img" src={project_pic} alt="RenewWool"/>
